//the below has been copied from https://github.com/Trouv/bevy_ecs_ldtk/blob/main/examples/platformer/walls.rs
...
impl Plugin for WallPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Update, spawn_wall_collision)
            .register_ldtk_int_cell::<WallBundle>(1); //stone
            // in the ldtk example code the below is stone and above is wood, I currently only have "stone" int cell values.
